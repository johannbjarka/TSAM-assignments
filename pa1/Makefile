...
dist:
	...
	install -m 0644 data/example_data1 data/example_data2 data/example_data3 ${COURSE}/${HOMEWORK}/data
	...
	install -m 0664 src/tftpd.c ${COURSE}/${HOMEWORK}/src/tftpd.c
	tar cvzf ${HOMEWORK}.tar ${COURSE}/${HOMEWORK}/data ${COURSE}/${HOMEWORK}/Makefile ${COURSE}/${HOMEWORK}/src/Makefile ${COURSE}/${HOMEWORK}/src/README ${COURSE}/${HOMEWORK}/src/AUTHORS ${COURSE}/${HOMEWORK}/src/tftpd.c
